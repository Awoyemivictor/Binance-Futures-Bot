...
symbol = ['BTC/USDT', 'ETH/USDT', 'BNB/USDT', 'AVAX/USDT', 'MATIC/USDT']  ## If Trade_All_Coins is False then we list the coins we want to trade here, otherwise the bot will automatically get all coins and trade them

# 'BTC/USDT', 'ETH/USDT', 'BNB/USDT', 'AVAX/USDT', 'MATIC/USDT'